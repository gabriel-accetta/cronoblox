...
describe("report evidence integrity", () => {
  it("rejects missing evidence references", () => {
    const report = ReportSchema.parse({ run_id: fact.run_id, game: { name: "Game", place_id: "1", universe_id: "2", creator: "Creator", observed_at: "2026-08-29T12:00:00.000Z", thumbnail_url: null }, user_mode: "developer", verdict: { breakout_potential: "MODERATE", confidence: "LOW", recommendation: "Watch" }, initial_verdict: { breakout_potential: "MODERATE", confidence: "LOW" }, audit_cards: [], supporting_claims: [{ id: "c1", text: "Claim", evidence_ids: ["missing"] }], risk_claims: [], critic: { changed_assessment: false, summary: "None", objections: [] }, next_action: "Watch", monitor: [], limitations: [], source_failures: [], runtime_ms: 1, approximate_cost_usd: 0, evidence_ids: [], is_fixture: true });
