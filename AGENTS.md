...
pnpm evaluate --remote <origin>   # ...or read them back through a deployed instance's public API
pnpm trajectory [--remote <origin>] <id>  # export one run's agent trace to trajectories/*.md
```
